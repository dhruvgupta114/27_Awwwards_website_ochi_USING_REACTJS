    ...
    <div className="flex gap-5 w-full h-screen bg-zinc-900 p-20">
      <div className="w-1/2 flex flex-col justify-between h-full ">
        <div className="heading">
          <h1 className="text-[6vw] font-semibold uppercase leading-loose -mb-10">
            EYE-
          </h1>
      ...
      <div className="w-1/2">
        <h1 className="text-[5vw] font-semibold uppercase leading-loose -mb-10">
          Presentations
          
        </h1>
        <div className="dets font-[Neue_Montreal] mt-10">
            {["Facebook", "Instagram", "Twitter"].map((item,index)=>(
                <a className="block text-xl font-light" href="#" key={index}>{item}</a>
            ))}
          </div>
      </div>
    </div>
